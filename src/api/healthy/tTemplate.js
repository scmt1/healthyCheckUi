...
//生成体检报告 TypeStatus true 复查人员报告信息查询
export const generateReportByPersonIdsTypeStatus= (params) => {
	return postBodyRequest('/tTemplate/generateReportByPersonIdsTypeStatus', params);
};
//生成体检报告(复查报告)
...
//生成体检报告(个人体检结论)
export const generateReportByPersonIdsTJJL= (params) => {
	return postBodyRequest('/tTemplate/generateReportByPersonIdsTJJL', params);
};
