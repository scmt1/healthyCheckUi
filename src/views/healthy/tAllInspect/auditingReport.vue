<template>
    ...
    <Modal v-model="show" title="审核个人报告" class="auditingReport" :mask-closable="false" :fullscreen="isFullscreen" :width="modalWidth" :footer-hide="true">
        ...
        <div slot="footer">
            ...
            <Button type="primary" :loading="btnLoading" @click="handelSubmit" v-if="!footerHide">审核</Button>
        </div>
    </Modal>
</template>
        ...
        methods: {
            init() {
                ...
                if (this.ReviewPerson){
                    this.personIds.push(this.ReviewPerson)
                }else {
        ...
        watch: {
            ...
            show(val) {
                if (val) {
                    ...
                    // this.modalWidthOld = this.modalWidth;
                    // window.onresize = () => {
                    //     // 计算高度
                    //     let height = document.documentElement.clientHeight;
                    //     element.style.height = (height - 300) + "px";
