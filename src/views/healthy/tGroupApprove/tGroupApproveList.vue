                    ...
                    <Col :span="18">
                        <Card class="d-card" v-if="groupOrderList.length >  0">
                            <Row>
                                ...
                                <Button type="primary" :loading="loading" @click="handelSubmit" v-if="orderInfo.auditState==4">评审报告预览</Button>
                    ...
                    <Col :span="6" style="padding-left: -15px;">
                        <Card class="d-card">
                            ...
                            <Card v-if="orderInfo && orderInfo.id && orderInfo.id.trim().length > 0" style="height: calc(100% - 50px);min-width: 300px;">
                                <Form ref="tGroupOrderForm" :model="orderInfo" :label-width="75"
                                      class="form">
                                    <Row>
                                        <Col span="24">
                                            <FormItem label="合同名称:">
    ...
    export default {
        ...
        methods: {
            ...
            submitApproveListShowPage(){
                ...
                this.searchForm.groupUnitNameme = '';
                // 重新加载数据
                let _this = this;
                setTimeout(function () {
