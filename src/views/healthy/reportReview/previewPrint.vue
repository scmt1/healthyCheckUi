...
<script>
	...
	export default {
		...
		methods: {
			...
			//模板数据初始化templateData.templateName = this.$hospitalName.templateName;//模板名称
			dataInit() {
			...
			fgnDataInit(tableMonitoring, data) {
                ...
                let vitalCapacityShort1=["M/B1","MVV/BSA","V75","V50/25","V50","V25/H","V25","PEF","MVV1","MMF","FVC%","FVC","FEV3%","FEV3","FEV2%","FEV2","FEV1","FEV1%","%FEVone","用力呼气肺活量(ML)"];
