...
<!--            <Col :span="span" v-if="tabPanes.length >0 && personData.length>0" style="position: relative;">-->
            <Col :style="span">
                <templateShow ref="templateShow" style="height: 100vh;overflow:hidden;" v-if="isTemplateShow" :isReview="searchForm.isReviewer" :personIds="personIds" :isBatchPrint="isBatchPrint"
...
<script>
    ...
    import {generatePhysicalExaminationReport,generateReportByPersonId,generateReportByPersonIds,generateReportByPersonIdsFC,generateReportByPersonIdsNotice,generateReportByPersonIdsfirstPage,generateWordReport,getReportWordBatch} from '@/api/healthy/tTemplate'
