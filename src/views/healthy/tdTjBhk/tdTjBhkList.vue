...
export default {
    ...
    data() {
        return {
            ...
            companyList: [],
            colOptions: ["企业名称", "人员姓名", "性别", "证件号码", "年龄", "婚否", "人员联系电话",  "接害因素", "接害工龄年数", "接害工龄月数", "工种其他名称", "体检日期", "体检结果", "主检建议", "体检结论", "主检医师", "开始接害日期", "网传状态", "操作"],
            colSelect: ["企业名称", "人员姓名", "性别", "证件号码", "年龄", "婚否", "人员联系电话",  "接害因素", "接害工龄年数", "接害工龄月数", "工种其他名称", "体检日期", "体检结果", "主检建议", "体检结论", "主检医师", "开始接害日期", "网传状态", "操作"],
        }
    },
    methods: {
        syncData() {
