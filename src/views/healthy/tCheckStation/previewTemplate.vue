<template>
    ...
    <Modal v-model="show" title="预览" class="previewTemplateCheck" :mask-closable="false" :fullscreen="isFullscreen" :width="modalWidth">
        ...
        init() {
            ...
            if (!_this.TTemplateId) {//非问诊科
                ...
                if(this.$hospitalName.isUserConfigure){//是否使用这个配置
                    d.reportDoctor = this.$hospitalName.reportDoctor;
                }
                ...
                if(officeName.indexOf("五官科") > -1 && name.indexOf("眼") <= -1){
                ...
                if((officeName.indexOf("五官科") > -1 && name.indexOf("眼") > -1) || officeName.indexOf("眼科") > -1){
                ...
                if (_this.personInfo) {
                    ...
                    if (_this.personInfo.workStateText) {
                        templateData.workStateText = _this.personInfo.workStateText;//监护种类(在岗状态)
                    }
                    if (_this.personInfo.workYear) {
                        templateData.workYe = _this.personInfo.workYear + "年";//总工龄年
                    }
                    if (_this.personInfo.workMonth) {
                    ...
                    if (_this.personInfo.exposureWorkYear) {
                        templateData.expYear = _this.personInfo.exposureWorkYear + "年";//接害工龄
                    }
                    if (_this.personInfo.exposureWorkMonth) {
