<template>
    <div style="height:100vh;">
            ...
            <Col class="layout">
                <div style="display: grid">
                    ...
                    <Row style="margin: 0 30px;color: rgb(41,96,226);width: 100%;">
                        <div style="width: auto;cursor: pointer;text-decoration:underline;" @click="previewFile">用户手册</div>
                    </Row>
        ...
        <div class="login-span">
            <span>友情链接:</span>
            <a href="https://www.sccdc.cn" title="链接到四川省疾病预防控制中心" target="_blank">四川省疾病预防控制中心</a>
            <a href="http://wsjkw.sc.gov.cn" title="链接到四川省卫生健康委员会" target="_blank">四川省卫生健康委员会</a>
            <a href=" http://ylbzj.sc.gov.cn" title="链接到四川省医疗保障局" target="_blank">四川省医疗保障局</a>
        </div>
