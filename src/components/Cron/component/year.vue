<template lang="html">
  <div :val="value_">
    <div>
      <Radio v-model="type" label="1" size="small" border>每年</Radio>
    </div>
    <div>
    ...
    <div>
      ...
      <InputNumber v-model="cycle.start" :min="2000" size="small" style="width: 100px;"@on-change="type = '2'" />
      <span style="margin-left: 5px; margin-right: 5px;">至</span>
      <InputNumber v-model="cycle.end" :min="2000" size="small" style="width: 100px;"@on-change="type = '2'" />
      年
    </div>
  </div>
</template>
